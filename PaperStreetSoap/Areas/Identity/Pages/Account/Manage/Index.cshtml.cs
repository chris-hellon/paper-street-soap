...
namespace PaperStreetSoap.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            SignInManager<ApplicationUser> signInManager, IAzureStorageRepository azureStorageRepository)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                user.ProfileImageUrl = await _azureStorageRepository.UploadImage(Input.ProfileImage, "users", user.Id);
